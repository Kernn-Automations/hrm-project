...
function Ongoing() {
  ...
  if (showRouteForm) {
    return <AddRouteForm district={selectedDistrict} onClose={() => setShowRouteForm(false)}/>;
  }
          ...
          <>
            {selectedDistrict.BMCS.map((bmc, index) => (
              <div key={index} className={styles.content}>
                ...
                <button className={styles.viewButton} onClick={() => setShowRouteForm(true)}>View </button>
              </div>
            ))}
