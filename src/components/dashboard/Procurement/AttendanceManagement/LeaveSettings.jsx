        ...
        <div className={styles.container}>
            <div className={styles.leaveBox}>
                ...
                <div className={styles.leaveFormGrid}>
                    {leaveEntries.map((leave, i) => (
                        <div key={i} className={styles.leaveInnerGird}>
                            <input
                                ...
                                readOnly
                            />
                            <select className={styles.leaveInput} value={leave.frequency} disabled>
                            ...
                            {
                                editClick && <button className={styles.deleteBin}>
                    ...
                    {editClick && <div className={styles.leaveInnerGird} >
                        ...
                        <select
                            ...
                            onChange={(e) => setNewLeave({ ...newLeave, frequency: e.target.value })}
                        >
                        ...
                        <input
                            ...
                            onChange={(e) => setNewLeave({ ...newLeave, maxDays: e.target.value })}
                        />
                        <BootstrapSwitch />
                    </div>}
                </div>
            ...
            {
                editClick && <div className={styles.editButtonContainer}>
                    <button className={styles.approveButton} onClick={handleAddLeave}>
                        + Add
                    </button>
                    <button onClick={onEditClick} className={styles.declineButton}>Cancel</button>
                </div>
            }
