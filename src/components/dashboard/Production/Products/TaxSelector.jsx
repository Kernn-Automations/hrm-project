  ...
  const [allTaxes, setAllTaxes] = useState([
    {
      applicableOn: null,
      cessPercentage: null,
      createdAt: "2025-06-09T02:23:37.548Z",
      description: null,
      hsnCode: null,
      id: 7,
      isAdditionalDuty: false,
      isCess: false,
      name: "TEST EXEMPT HSN",
      percentage: null,
      status: "Active",
      taxNature: "Exempt",
    },
    ...
    <>
        ...
        return (
          ...
          >
            ...
            <small className="text-muted">
              <div>
                <b>Percentage:</b> {tax.percentage}%
              </div>
              <div>
                <b>Nature:</b> {tax.taxNature}
              </div>
              <div>
                <b>Applicable On:</b> {tax.applicableOn}
              </div>
              {tax.hsnCode && (
                <div>
                  <b>HSN Code:</b> {tax.hsnCode}
                </div>
              )}
              {tax.description && (
                <div>
                  <b>Description:</b> {tax.description}
                </div>
              )}
              {tax.isCess && (
                <div>
      ...
      {hasExemptTax ? (
        <div className="alert alert-warning mt-2 p-2">
          <strong>Note:</strong> An <b>Exempt</b> tax is selected. No other
          taxes can be added.
        </div>
        ...
        <p className="text-muted mt-2">All taxes are selected.</p>
      )}
