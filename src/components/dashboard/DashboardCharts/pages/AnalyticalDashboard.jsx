  ...
  return (
    <>
      <div className="flex items-center justify-between p-3">
        <div>
          ...
          <p className="text-gray-600">
            Comprehensive overview of dairy operations
          </p>
        </div>
      ...
      <div className="space-y-6 p-3 bg-gray-50 text-gray-900">
        ...
        {/* Additional Info */}
        <div className="grid grid-cols-1 lg:grid-cols-1 gap-6 my-4">
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-3">
            <h6 className="text-lg font-semibold text-gray-900 mb-4">
              System Alerts
            </h6>
            <div className="space-y-3">
              <div className="flex items-center space-x-2 mb-2">
                ...
                <span className="text-sm text-gray-600 ps-3">
                  Low stock alert for Butter
                </span>
              </div>
              <div className="flex items-center space-x-2 mb-2">
                <AlertTriangle className="h-4 w-4 text-red-500" />
                <span className="text-sm text-gray-600 ps-3">
                  Payment overdue for Supplier A
                </span>
              </div>
              <div className="flex items-center space-x-2 mb-2">
                <AlertTriangle className="h-4 w-4 text-yellow-500" />
                <span className="text-sm text-gray-600 ps-3">
                  Quality check required for new batch
                </span>
              </div>
            </div>
          </div>
