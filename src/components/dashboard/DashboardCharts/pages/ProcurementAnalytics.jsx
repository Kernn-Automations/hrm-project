      ...
      <div className="flex items-center justify-between mb-3 p-3">
        <div>
          ...
          <p className="text-gray-600">
            Milk procurement and quality management
          </p>
        </div>
      </div>
            ...
            <div className="flex items-center justify-between p-3">
              <div>
                <p className="text-sm font-medium text-gray-600 mb-0">
                  Milk Procuring Quantity
                </p>
                <p className="text-2xl font-bold text-gray-900 mt-1 mb-0">
                  Avg Fat: 3.9%
                </p>
                <p className="text-sm text-gray-500 mt-1 mb-0">Avg SNF: 8.2%</p>
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 my-4">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-3">
            <h6 className="text-lg font-semibold text-gray-900 mb-4">
              Milk Procured (liters){" "}
              <span className="text-xs text-gray-500">(in a week)</span>
            </h6>
