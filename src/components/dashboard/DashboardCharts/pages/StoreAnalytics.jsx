  ...
  return (
    <>
      <div className="flex items-center justify-between p-3">
        <div>
          <h3 className="text-2xl font-bold text-gray-900">Stores Analytics</h3>
      ...
      <div className="space-y-6  p-3 bg-gray-50 text-gray-900">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-4">
          ...
          <MetricCard
            ...
            icon={AlertTriangle}
          />
          <MetricCard title="Available Stock" value="8,600 L" icon={Package} />
          <MetricCard title="Stock Turnover" value="4.2x" icon={TrendingUp} />
        </div>

        {/* Total Stock Alerts Card (IMPROVED) */}
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 flex flex-col items-center justify-center shadow-md rounded-lg p-3 my-4 ">
          <h6 className="text-lg font-bold text-gray-900 mb-4 text-center">
            Total Stock Alerts
          </h6>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 my-4">
          {/* Stock Levels */}
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-3 px-4">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-3">
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200 table">
              <thead className="bg-gray-50 bg-secondary">
                <tr>
